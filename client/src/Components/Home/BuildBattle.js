    ...
    return (
        <div className="home-build-team-create-trainer-container">
            ...
            <div className="home-battle-description-card" style={{backgroundColor:'violet'}}>
                {displayMewTwo === false ? <img className="home-image-thumbnail" style={{backgroundColor:'purple'}} src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/150.png" alt="pokemon" onClick={viewMewTwo}/>
                :
